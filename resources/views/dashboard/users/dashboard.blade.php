...
@section('container')
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mt-4">
            ...
            {{-- pending --}}
            <div
                class="flex items-center p-5 bg-linear-to-br from-gray-500 to-gray-600 text-white rounded-xl shadow-md hover:shadow-lg transition-shadow">
                <div class="p-3 bg-white/20 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-7 h-7">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div
                ...
                <div class="ml-4">
                    ...
                    <p class="text-sm opacity-90">Closed Ticket</p>
                </div>
            </div>
        </div>
