        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mt-6">
            ...
            <div
                ...
                <div class="ml-4">
                    ...
                    <p class="text-sm opacity-90">Total Ticket</p>
                </div>
            </div>

            <!-- Open Tickets -->
            <div
                class="flex items-center p-5 bg-linear-to-br from-blue-300 to-esky-600 text-white rounded-xl shadow-md hover:shadow-lg transition-shadow">
                <div class="p-3 bg-white/20 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-7 h-7">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="ml-4">
                    ...
                    <p class="text-sm opacity-90">Open Ticket</p>
                </div>
            </div>
            ...
            {{-- pending --}}
            <div
                class="flex items-center p-5 bg-linear-to-br from-gray-400 to-gray-500 text-white rounded-xl shadow-md hover:shadow-lg transition-shadow">
                <div class="p-3 bg-white/20 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-7 h-7">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div class="ml-4">
                    <h4 class="text-3xl font-bold">{{ $pendingTickets }}</h4>
                    <p class="text-sm opacity-90">Pending Ticket</p>
                </div>
            </div>
            ...
            <div
                ...
                <div class="ml-4">
                    ...
                    <p class="text-sm opacity-90">Close Ticket</p>
                </div>
            </div>
