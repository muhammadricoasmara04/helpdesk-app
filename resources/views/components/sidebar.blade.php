    ...
    <nav class="flex flex-col flex-1 overflow-y-auto px-3 py-6 gap-2">
        ...
        @if ($user['role'] === 'admin')
            ...
            <x-link-group title="Ticket" icon="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-5.25h5.25M7.5 15h3"
                :routes="['ticket.index', 'ticket-status', 'ticket-priority']">
                ...
                <x-link route="ticket-priority"
                    icon="M12 9v3.75m9-.75a9 9 0 1 1-18 0 9 9 0 0 1 18 0Zm-9 3.75h.008v.008H12v-.008">
                    Tiket Prioritas
                </x-link>
            ...
            <x-link-group title="Layanan"
                ...
                :routes="['application', 'application-problems']">
